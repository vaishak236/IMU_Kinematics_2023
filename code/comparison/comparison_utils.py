...
imu_path	= '../../results/uncon/imu_uncon_ik_npy/s4_alex/'

mocap_sync_fn	= 'OpenSim_Sub04_CombinedTasks_markers_mocap_pelvis_acc.npy'
imu_sync_fn		= 's4_alex_combine_10min_pelvis_acc_x.npy'
